...
<template>
  <div
    :class="[
      !ppm ? 'bg-gray-400' : ppm <= 800 ? 'bg-[#7DBF70]' : ppm <= 1200 ? 'bg-[#EBAC56]' : 'bg-[#E1665E]',
  ...
  >
    <div class="flex justify-between font-bold">
      ...
      <div :data-tip="installationTooltip(isPublic)" class="tooltip ml-1 h-8 w-8 shrink-0">
    ...
    <div class="mt-6 flex justify-between">
      <div class="flex flex-col">
        <div class="text-lg font-bold text-gray-900">{{ $t('Latest') }} CO<sub>2</sub> {{ $t('Value') }}</div>
